...
//       `Base URL: ${BLUE}${config.BASE_URL}:${config.PORT}${RESET} \n`,
//       `Environment: ${BLUE}${config.NODE_ENV}${RESET} \n`,
//       `Port: ${BLUE}${config.PORT}${RESET} \n`,
//     );
//     logRoutesByModule();
//   } catch (error: any) {
//     console.error(
//       `${YELLOW}⚠${RESET} ${WHITE}Failed to connect to MongoDB:${RESET}`,
//       error,
//     );
//     process.exit(1);
//   }
