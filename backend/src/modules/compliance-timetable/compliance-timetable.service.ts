...
/**
 * Service function to delete multiple compliance-timetable by their IDs.
 * Access control is not applied here as it's assumed that the caller has already verified access to these IDs.
 * @param {IdOrIdsInput['ids']} ids - The IDs of the compliance-timetable to delete.
 * @returns {Promise<Partial<IComplianceTimeTable>[]>} - The deleted compliance-timetable.
 * @throws {Error} - Throws an error if no compliance-timetable is found to delete.
 */
