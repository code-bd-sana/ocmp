...
export const updateTrafficCommissionerCommunication = catchAsync(
  async (req: Request, res: Response) => {
    ...
    if (!result) throw new Error('Failed to update traffic-commissioner-communication');
...
export const deleteTrafficCommissionerCommunication = catchAsync(
  async (req: Request, res: Response) => {
    ...
    if (!result) throw new Error('Failed to delete traffic-commissioner-communication');
