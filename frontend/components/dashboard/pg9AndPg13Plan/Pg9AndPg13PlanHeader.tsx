...
interface Pg9AndPg13PlanHeaderProps {
  clientName?: string;
  searchQuery: string;
  onSearchChange: (value: string) => void;
}

export default function Pg9AndPg13PlanHeader({
  clientName,
  searchQuery,
  onSearchChange,
}: Pg9AndPg13PlanHeaderProps) {
  return (
    <div className="">
      <div className="flex flex-col justify-between gap-y-3 md:flex-row md:gap-x-3">
        ...
        <div className="relative flex max-w-xl items-center text-(--input-foreground)">
          ...
          <Input
            type="text"
            placeholder="Search by pg9 and pg13 plan details"
            value={searchQuery}
