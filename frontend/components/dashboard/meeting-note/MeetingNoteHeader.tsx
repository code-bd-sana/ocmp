...
interface MeetingNoteHeaderProps {
  searchQuery: string;
  onSearchChange: (value: string) => void;
}

export default function MeetingNoteHeader({
  searchQuery,
  onSearchChange,
}: MeetingNoteHeaderProps) {
  return (
    <div className="mb-4 flex flex-col justify-between gap-y-3 md:flex-row md:gap-x-3">
      <h2 className="text-primary text-3xl font-bold">Meeting Notes</h2>
