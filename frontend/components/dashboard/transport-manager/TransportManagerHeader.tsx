...
interface TransportManagerTrainingHeaderProps {
  searchQuery: string;
  onSearchChange: (value: string) => void;
}

export default function TransportManagerTrainingHeader({
  searchQuery,
  onSearchChange,
}: TransportManagerTrainingHeaderProps) {
  return (
    <div>
      <div className="flex flex-col justify-between gap-y-3 md:flex-row md:gap-x-3">
        ...
        <div className="relative flex max-w-xl items-center text-(--input-foreground)">
          ...
          <Input
            type="text"
            placeholder="Search by training course or unit title"
            value={searchQuery}
